  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className="bannerImage animate__animated animate__fadeIn" style={{backgroundImage:`url("${srcImagen}")`}}>
          <img className="bannerFondo" src={srcImagen} alt="" />
          <div className="bannerDescription">
            <h1>{movie.title} </h1>
            <p>{movie.overview}</p>
            <button type="button" className="btn btn-light">
              <i className="bi bi-play-fill"></i> { page=="movie" ? "Play" : "First chapter" }
            </button>
